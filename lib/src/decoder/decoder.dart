...
final class BjdataDecoder extends Converter<List<int>, Object?> {
  ...
  /// values.
  ///
  /// Structure-of-Arrays containers decode to plain types: either layout becomes a
  /// [List] of record [Map]s, nested according to its dimensions. Within an SoA
  /// payload the reviver is invoked for each field value with the schema field name
  /// as the key, and not for the records holding them.
  ///
