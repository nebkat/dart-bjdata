...
final class BjdataConfig {
  ...
  /// Output written to draft 4, which is what the defaults already do.
  ///
  /// Stays draft 4 if a later revision becomes the default.
  static const BjdataConfig draft4 = BjdataConfig(version: BjdataVersion.draft4);
