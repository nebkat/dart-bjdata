...
BjdataVersion _draft(List<String> arguments) {
  ...
  final number = int.tryParse(draft);
  final version = number == null ? null : BjdataVersion.fromValueOrNull(number);
  if (version == null) {
...
Iterable<int> get _draftNumbers => BjdataVersion.values.map((version) => version.value);
