    ...
    group('layout', () {
      ...
      test('both layouts decode to the same records', () {
        for (final layout in [BjdataSoaLayout.rowMajor, BjdataSoaLayout.columnMajor]) {
          expect(bjdataDecode(bjdataEncode(records, soa: layout)), records, reason: '$layout');
        }
      });
      ...
      test('offset tables follow the payload in both layouts', () {
        ...
        for (final layout in [BjdataSoaLayout.rowMajor, BjdataSoaLayout.columnMajor]) {
          expect(bjdataDecode(bjdataEncode(table, soa: layout)), table, reason: '$layout');
        }
      });
      ...
      test('n-dimensional works in both layouts', () {
        ...
        for (final layout in [BjdataSoaLayout.rowMajor, BjdataSoaLayout.columnMajor]) {
          expect(bjdataDecode(bjdataEncode(grid, soa: layout)), grid, reason: '$layout');
        }
      });
